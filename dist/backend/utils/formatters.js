...
export class CVPlusLogFormatter {
    constructor(options = {}) {
        var _a;
        this.enablePIIRedaction = (_a = options.enablePIIRedaction) !== null && _a !== void 0 ? _a : true;
    ...
    format(entry) {
        ...
        Object.keys(formattedEntry).forEach(key => {
            if (formattedEntry[key] === undefined) {
                delete formattedEntry[key];
            }
        });
    ...
    redactObjectPII(obj) {
        ...
        Object.keys(obj).forEach(key => {
            ...
            const isSensitiveField = allSensitiveFields.some(sensitiveField => lowerKey.includes(sensitiveField.toLowerCase()));
            if (isSensitiveField) {
